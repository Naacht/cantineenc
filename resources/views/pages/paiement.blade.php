...
<div class="max-w-7xl mx-auto p-6 lg:p-8">
    <div class="flex items-center justify-center mb-4">
        ...
        <h1 class="ml-4 text-xl font-semibold text-gray-900">Paiement</h1>
    </div>
    ...
    <div class="mt-6">
        ...
        <a href="{{ url('/dashboard') }}" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Accueil</a>
