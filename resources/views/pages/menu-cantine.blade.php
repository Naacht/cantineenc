...
<body class="antialiased min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
        <div class="flex items-center justify-center mb-4">
            ...
            <h1 class="ml-4 text-xl font-semibold text-gray-900">Menu de la semaine</h1>
        </div>
        ...
        <div class="mt-6 flex items-center justify-center">
            <p class="text-green-500"><a href="{{ route('reservation') }}" class="text-blue-500">Réservation ici</a></p>
