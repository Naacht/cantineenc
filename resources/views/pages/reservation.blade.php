...
<div class="max-w-7xl mx-auto p-6 lg:p-8">
    <div class="flex items-center justify-center mb-4">
        ...
        <h1 class="ml-4 text-xl font-semibold text-gray-900">Réservation de la cantine</h1>
    </div>
    <body>
    <div class="mt-6 reservation-container">
            @csrf
            ...
            <div class="form-group">
                <button type="submit" id="reservation-btn">Réserver</button>
            </div>
